...
def compute_C1(data, mensili, birdstrike):
    ...
    if tmp_birdstrike.shape[0] > 0:
        return C1/tmp_birdstrike.shape[0]
    return C1
...
def compute_C2(data, birdstrike):
    ...
    if tmp_birdstrike.shape[0] > 0:
        return C2 / tmp_birdstrike.shape[0]
    return C2
...
def compute_C3(data, birdstrike):
    ...
    if tmp_birdstrike.shape[0] > 0:
        return C3/tmp_birdstrike.shape[0]
    return C3
...
def compute_C4(data, birdstrike):
    ...
    if tmp_birdstrike.shape[0] > 0:
        return C4/tmp_birdstrike.shape[0]
    return C4

def compute_C5(data, scheda, birdstrike):
    ''' Setting dates '''
    next_data = increase_month(data)
    ...
    if tmp_birdstrike.shape[0] > 0:
        return C5/tmp_birdstrike.shape[0]
    return C5
...
def WRI(data, mensili, birdstrike, scheda):
    ...
    for i in range(years*n_months):
        ...
        C5 = compute_C5(data, scheda_PSA, birdstrike_PSA)
